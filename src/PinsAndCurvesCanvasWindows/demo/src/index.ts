...
const vh3 = NormalVectorHandle.Node({id: 'v3',range: [-100,100],displayLine: true,initialDirection: [1,1],discrete: true, onionSkin: true});
...
const camera = Camera.Node();

CreateScene([camera],{numberOfFrames: 100});
